...
case $ID in
    ...
    *centos*|*almalinux*|*rocky*)
	...
	case $REPO in
	    ...
	    exp/lts/6)
		set +e
		cat /host/sh/install-redhat-fluent-package6-lts.sh | sed -e 's,/6,/test/experimental/lts/6,'
		cat /host/sh/install-redhat-fluent-package6-lts.sh | sed -e 's,/6,/test/experimental/lts/6,' | sh
		set -e
