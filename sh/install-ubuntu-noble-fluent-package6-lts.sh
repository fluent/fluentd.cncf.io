...
sudo sh <<SCRIPT
  ...
  curl -o fluent-apt-source.deb https://packages.treasuredata.com/lts/6/ubuntu/noble/pool/contrib/f/fluent-lts-apt-source/fluent-lts-apt-source_2025.7.29-1_all.deb
