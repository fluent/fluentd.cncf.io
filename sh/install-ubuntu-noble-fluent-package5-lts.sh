...
sudo sh <<SCRIPT
  ...
  curl -o fluent-apt-source.deb https://packages.treasuredata.com/lts/5/ubuntu/noble/pool/contrib/f/fluent-lts-apt-source/fluent-lts-apt-source_2025.1.8-1_all.deb
