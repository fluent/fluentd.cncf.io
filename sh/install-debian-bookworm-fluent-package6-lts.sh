...
sudo sh <<SCRIPT
  ...
  curl -o fluent-apt-source.deb https://fluentd.cdn.cncf.io/lts/6/debian/bookworm/pool/contrib/f/fluent-lts-apt-source/fluent-lts-apt-source_2025.7.29-1_all.deb
